...
namespace gtl::gfx {
    ...
    __CASET requires std::is_arithmetic_v<T>
        ...
        __CXIN vec2<value_type> operator*(vec2<value_type>&& rhs) const requires ArithNoBool_<value_type> {
        ...
        __CXIN vec2<value_type> operator*(value_type&& rhs) const requires ArithNoBool_<value_type> {
        ...
        __CXIN void operator*=(vec2<value_type>&& rhs) requires ArithNoBool_<value_type> {
            x *= std::move(rhs.x);
            y *= std::move(rhs.y);
        }
        ...
        __CXIN vec2<value_type> operator*(const vec2<value_type>& rhs) const requires ArithNoBool_<value_type> {
        ...
        __CXIN vec2<value_type> operator*(const value_type& rhs) const requires ArithNoBool_<value_type> {
        ...
        __CXIN void operator*=(const vec2<value_type>& rhs) requires ArithNoBool_<value_type> {
            x *= rhs.x;
            y *= rhs.y;
        }
 ...
 return vec2<value_type>(-(x), -(y));
        ...
        [[nodiscard]] __CXIN float_type angle() const requires (ArithNoBool_<value_type>&& ArithSigned_<value_type>) {
            if (std::signbit(x)) {
                return std::signbit(y) ? std::atan2(-y, x) : -(std::atan2(y, x));
            }
            else {
                return (std::numbers::pi_v<float_type> *2) - std::atan2(y, x);
            }
        }
        ...
        [[nodiscard]] __CXIN float_type ratio() const requires ArithNoBool_<value_type> {
            __CXIF(Floating_<value_type>) {
                return x / y;
            }
 else {
 ...
 y = -y;
        ...
        __CXIN const vec2<value_type>& clamp(value_type max_length) requires ArithNoBool_<value_type> {
        ...
        __CXIN const vec2<value_type>& stretch(value_type new_length) requires ArithNoBool_<value_type> {
            auto this_length = length();
        ...
        __CXIN const vec2<value_type>& normalize() requires Floating_<value_type> {
        ...
        constexpr const vec2<value_type>&
            step_to(vec2<value_type> point, value_type magnitude)requires ArithNoBool_<value_type> {
            auto& this_vec = *this;
        ...
        __CXIN const vec2<value_type>&
            step(vec2<value_type> direction_normal, value_type magnitude)requires Floating_<value_type> {
        ...
        [[nodiscard]] __CXIN value_type dot(const vec2<value_type>& other) const requires ArithNoBool_<value_type> {
        ...
        [[nodiscard]] __CXIN value_type cross(const vec2<value_type>& other) const requires ArithNoBool_<value_type> {
        ...
        [[nodiscard]] __CXIN value_type angle_to(const vec2<value_type>& other) const requires Floating_<value_type> {
        ...
        [[nodiscard]] __CXIN value_type
            angle_to_point(const vec2<value_type>& other) const requires Floating_<value_type> {
        ...
        [[nodiscard]] __CXIN value_type
            length_to_squared(const vec2<value_type>& other) const requires ArithNoBool_<value_type> {
        ...
        [[nodiscard]] __CXIN value_type
            length_to(const vec2<value_type>& other) const requires ArithNoBool_<value_type> {
        ...
        [[nodiscard]] __CXIN vec2<value_type> normalized() const requires Floating_<value_type> {
        ...
        [[nodiscard]] __CXIN vec2<value_type>
            direction_to(const vec2<value_type>& other) const requires Floating_<value_type> {
        ...
        [[nodiscard]] __CXIN vec2<value_type> clamped(value_type new_length) const requires ArithNoBool_<value_type> {
            if (value_type this_length = length() > value_type() && new_length < this_length) {
  ...
  return vec2<value_type>(std::abs(x), std::abs(y));
            ...
            [[nodiscard]] __CXIN vec2<value_type> ceil() const requires Floating_<value_type> {
        ...
        [[nodiscard]] __CXIN vec2<value_type> floor() const requires Floating_<value_type> {
        ...
        [[nodiscard]] __CXIN vec2<value_type>
            mod(vec2<value_type> denominator) const requires ArithNoBool_<value_type> {
            __CXIF(Floating_<value_type>) {
 ...
 return vec2<value_type>(x % denominator.x, y % denominator.y);
        ...
        [[nodiscard]] __CXIN vec2<value_type>
            slide(vec2<value_type> plane_normal) const requires Floating_<value_type> {
#ifdef __DEBUG_ARITHMETIC_LOGIC_ASSERT
        ...
        [[nodiscard]] __CXIN vec2<value_type>
            reflect(vec2<value_type> plane_normal) const requires Floating_<value_type> {
#ifdef __DEBUG_ARITHMETIC_LOGIC_ASSERT
            assert(plane_normal.is_normalized());
#endif
        ...
        [[nodiscard]] __CXIN vec2<value_type>
            project(vec2<value_type> other_normal) const requires Floating_<value_type> {
#ifdef __DEBUG_ARITHMETIC_LOGIC_ASSERT
            assert(plane_normal.is_normalized());
#endif
        ...
        [[nodiscard]] __CXIN vec2<bool> sign() const requires std::numeric_limits<value_type>::is_signed{
            ...
            requires (ArithNoBool_<value_type>&& std::numeric_limits<value_type>::is_signed) {
